const validation = new JustValidate('#product-validation', {
  ...
  .addField('#image', [
      {
        ...
        errorMessage: '* Debes poner una foto con la extensión correcta',
      },
    ])
...
document.getElementById("ingredients").addEventListener("blur", () => {
  validation.revalidateField("#ingredients");
});

document.getElementById("image").addEventListener("blur", () => {
  validation.revalidateField("#image");
});
...
document.getElementById("size").addEventListener("blur", () => {
  validation.revalidateField("#size");
});

document.getElementById("price").addEventListener("blur", () => {
  validation.revalidateField("#price");
});

document.getElementById("stock").addEventListener("blur", () => {
  validation.revalidateField("#stock");
});
